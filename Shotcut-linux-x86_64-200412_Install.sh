...
sleep 2
mv /shotcut-linux-x86_64-200412.txz .
tar xf shotcut-linux-x86_64-200412.txz
mv Shotcut/ shotcut
#
#App a Menú
...
echo 'Version=20.04.12' >> shotcut.desktop
...
echo 'Version=20.04.12' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/shotcut-linux-x86_64-200412.txz
