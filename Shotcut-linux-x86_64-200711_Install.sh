...
wget https://github.com/mltframework/shotcut/releases/download/v20.07.11/shotcut-linux-x86_64-200711.txz
cd /usr/local/
...
sleep 2
mv /shotcut-linux-x86_64-200711.txz .
tar xf shotcut-linux-x86_64-200711.txz
mv Shotcut/ shotcut
#
#App a Menú
...
echo 'Version=20.07.11' >> shotcut.desktop
...
echo 'Version=20.07.11' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/shotcut-linux-x86_64-200711.txz
