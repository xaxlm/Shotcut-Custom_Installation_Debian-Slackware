#!/bin/bash
# Ultima actualización: 07/04/2018
cd /
# Se descarga Shotcut y logo
wget https://github.com/mltframework/shotcut/releases/download/v18.03/shotcut-linux-x86_64-180306.tar.bz2
...
sleep 2
mv /shotcut-linux-x86_64-180306.tar.bz2 /usr/local/$DIRINST
tar jvxf shotcut-linux-x86_64-180306.tar.bz2
...
echo 'Version=18.03' >> shotcut.desktop
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/shotcut-linux-x86_64-180306.tar.bz2
