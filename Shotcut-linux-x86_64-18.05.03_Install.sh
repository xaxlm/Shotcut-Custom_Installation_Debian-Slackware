#!/bin/bash
# Ultima actualización: 06/05/2018
cd /
# Se descarga Shotcut y logo
wget https://github.com/mltframework/shotcut/releases/download/v18.05/shotcut-linux-x86_64-180503.tar.bz2
...
sleep 2
mv /shotcut-linux-x86_64-180503.tar.bz2 /usr/local/$DIRINST
tar jvxf shotcut-linux-x86_64-180503.tar.bz2
...
echo 'Version=18.05.03' >> shotcut.desktop
...
echo 'Version=18.05.03' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/shotcut-linux-x86_64-180503.tar.bz2
