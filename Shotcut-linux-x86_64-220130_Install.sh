#!/bin/bash
# Ultima actualización: 09/03/2022
cd /
# Se descarga Shotcut y logo
wget https://github.com/mltframework/shotcut/releases/download/v22.01.30/shotcut-linux-x86_64-220130.txz
cd /usr/local/
...
sleep 2
mv /shotcut-linux-x86_64-220130.txz .
...
echo 'Version=22.01.30' >> shotcut.desktop
...
echo 'Version=22.01.30' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/shotcut-linux-x86_64-220130.txz
